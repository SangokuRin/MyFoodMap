...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="content">
            ...
            <center style="background-image: url(img/bg/bg_m3.jpg); margin-top: 50px;">
				  <div id="logoutbackground" style="background-image: url(img/bg/bg3.jpg);">
				    <p>&nbsp; </p>
				    <p>&nbsp;</p>
				    您已登出成功，歡迎下次再度光臨~~
