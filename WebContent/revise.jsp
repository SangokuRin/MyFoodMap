...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="page-title"  style="background-image: url('img/bg/bg_m3.jpg');">
            ...
            <div class="container clearfix">
                <span style="font-size: 26px;"><b>修改會員資料 </b></span><span style="font-size: 18px; color: #FF2D2D;">“更改密碼” 欄位可空白，空白代表密碼不修改。</span>
            </div>
        ...
        <section id="content">
            ...
            <center style="margin-top: 50px;">
				      ...
				      <form id="form1" name="form1" class="nobottommargin" action="Validatere.do" method="post" onsubmit="return checkdata();">
						...
						<table width="400" border="1" align="center" class="regtable" >
				                <div class="col_half" style="margin-top: 40px;">
				                    ...
				                    <input type="text" id="name" name="name" value="${name}" class="required form-control input-block-level" />
				                ...
				                <div class="col_half col_last" style="margin-top: 40px;">
				                    ...
				                    <input type="text" id="email" name="email" value="${email}" class="required form-control input-block-level" />
				                ...
				                <div class="col_half">
				                    ...
				                    <input type="text" id="account" name="account" value="${account}" readonly class="required form-control input-block-level" />
				                </div>
				
				                <div class="col_half">
				                    <label for="password" style="font-size: 120%;">更改密碼:</label>
				                ...
				                <div class="col_half col_last">
				                    <label for="password1" style="font-size: 120%;">確認新密碼:</label>
				                ...
				                <div class="message1 col_last" style="margin-bottom: 20px;">
			   		 				<span id="disperror" >${revisemessage}</span> 
			    				</div>
				       	...
				       	<p><input type="image" onclick="document.formname.submit();" src="img/btn/btn-rev1.png" style="width:100px ; height:32px;margin-bottom: 50px;"  /></p>
